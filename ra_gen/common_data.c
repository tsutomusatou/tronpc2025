...
const icu_extended_cfg_t g_int_gt911_ext_cfg =
...
{ .channel = 3, .trigger = EXTERNAL_IRQ_TRIG_RISING, .filter_enable = false, .clock_source_div =
  ...
  .p_context = &NULL,
#endif
  .p_extend = (void*) &g_int_gt911_ext_cfg,
  .ipl = (2),
...
.dsi_seq1.ipl = (12),
  ...
  .dsi_plie = R_DSILINK_PLIER_DLULPENT_Msk | R_DSILINK_PLIER_DLULPEXT_Msk | 0x0, .dsi_vmie = R_DSILINK_VMIER_VBUFUDF_Msk
          | R_DSILINK_VMIER_VBUFOVF_Msk | 0x0,
  .dsi_sqch0ie = R_DSILINK_SQCH0IER_AACTFIN_Msk | R_DSILINK_SQCH0IER_ADESFIN_Msk | R_DSILINK_SQCH0IER_TXIBERR_Msk
